...
class DiaryDayCalendar extends StatefulWidget {
  const DiaryDayCalendar({
    Key? key,
    this.width,
    this.height,
    this.onDateChange,
  ...
  @override
  _DiaryDayCalendarState createState() => _DiaryDayCalendarState();
}

class _DiaryDayCalendarState extends State<DiaryDayCalendar> {
