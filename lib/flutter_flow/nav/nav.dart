      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'JTPTopics')
              : const JTPTopicsWidget(),
        ),
        FFRoute(
          name: 'JTPDash',
          path: '/jTPDash',
        ...
        FFRoute(
          ...
          asyncParams: {
            'companyDoc': getDoc(['companies'], CompaniesRecord.fromSnapshot),
          },
        ...
        FFRoute(
          name: 'refreshAppState',
          path: '/refreshAppState',
          builder: (context, params) => const RefreshAppStateWidget(),
        ),
        FFRoute(
          name: 'socialSetup',
          path: '/socialSetup',
          builder: (context, params) => const SocialSetupWidget(),
        ),
        FFRoute(
          name: 'AIiNSTRUCTIONS',
          path: '/aIiNSTRUCTIONS',
          builder: (context, params) => const AIiNSTRUCTIONSWidget(),
        ),
        FFRoute(
          name: 'JTPChat',
          path: '/jTPChat',
        ...
        FFRoute(
          ...
          path: '/activityDetailsdIARY',
          asyncParams: {
            'companyDoc': getDoc(['companies'], CompaniesRecord.fromSnapshot),
          },
          builder: (context, params) => ActivityDetailsdIARYWidget(
            activityRef: params.getParam(
              'activityRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['diaryActivities'],
            ),
            companyDoc: params.getParam(
              'companyDoc',
              ParamType.Document,
        ...
        FFRoute(
          ...
          path: '/htmlContentPage',
          asyncParams: {
            'companyDoc': getDoc(['companies'], CompaniesRecord.fromSnapshot),
          },
          builder: (context, params) => HtmlContentPageWidget(
            activityRef: params.getParam(
              'activityRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['HTMLcontent'],
            ),
            companyDoc: params.getParam(
              'companyDoc',
              ParamType.Document,
