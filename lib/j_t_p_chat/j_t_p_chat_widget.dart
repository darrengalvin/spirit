...
import 'j_t_p_chat_model.dart';
export 'j_t_p_chat_model.dart';

class JTPChatWidget extends StatefulWidget {
  const JTPChatWidget({super.key});

  @override
  State<JTPChatWidget> createState() => _JTPChatWidgetState();
}

class _JTPChatWidgetState extends State<JTPChatWidget> {
  late JTPChatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JTPChatModel());
