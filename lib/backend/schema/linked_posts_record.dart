...
class LinkedPostsRecord extends FirestoreRecord {
  LinkedPostsRecord._(
    super.reference,
    super.data,
  ) {
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('linkedPosts');

  static Stream<LinkedPostsRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => LinkedPostsRecord.fromSnapshot(s));

  static Future<LinkedPostsRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => LinkedPostsRecord.fromSnapshot(s));

  static LinkedPostsRecord fromSnapshot(DocumentSnapshot snapshot) =>
      LinkedPostsRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static LinkedPostsRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      LinkedPostsRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'LinkedPostsRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is LinkedPostsRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createLinkedPostsRecordData({
  String? title,
  String? summary,
  String? description,
  DateTime? dateposted,
...
class LinkedPostsRecordDocumentEquality implements Equality<LinkedPostsRecord> {
  const LinkedPostsRecordDocumentEquality();

  @override
  bool equals(LinkedPostsRecord? e1, LinkedPostsRecord? e2) {
  ...
  @override
  int hash(LinkedPostsRecord? e) => const ListEquality().hash([
        e?.title,
        e?.summary,
        e?.description,
        e?.dateposted,
  ...
  @override
  bool isValidKey(Object? o) => o is LinkedPostsRecord;
}
