...
class LinkedEmailRecord extends FirestoreRecord {
  LinkedEmailRecord._(
    super.reference,
    super.data,
  ) {
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('linkedEmail');

  static Stream<LinkedEmailRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => LinkedEmailRecord.fromSnapshot(s));

  static Future<LinkedEmailRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => LinkedEmailRecord.fromSnapshot(s));

  static LinkedEmailRecord fromSnapshot(DocumentSnapshot snapshot) =>
      LinkedEmailRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static LinkedEmailRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      LinkedEmailRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'LinkedEmailRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is LinkedEmailRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createLinkedEmailRecordData({
  String? title,
  String? summary,
  String? description,
  DateTime? dateposted,
...
class LinkedEmailRecordDocumentEquality implements Equality<LinkedEmailRecord> {
  const LinkedEmailRecordDocumentEquality();

  @override
  bool equals(LinkedEmailRecord? e1, LinkedEmailRecord? e2) {
  ...
  @override
  int hash(LinkedEmailRecord? e) => const ListEquality().hash([
        e?.title,
        e?.summary,
        e?.description,
        e?.dateposted,
  ...
  @override
  bool isValidKey(Object? o) => o is LinkedEmailRecord;
}
