...
class _SidemenuWidgetState extends State<SidemenuWidget> {
  ...
  void initState() {
    ...
    _model.switchValue = FFAppState().editMode;
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                            ...
                            child: Image.network(
                              getCORSProxyUrl(
                                valueOrDefault<String>(
                                  currentUserPhoto,
                                  'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/jtp-app-fae7n5/assets/54esz3bv2962/image.png',
                                ),
                              ),
                              fit: BoxFit.cover,
                            ),
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(15.0, 0.0, 0.0, 15.0),
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                          ...
                          builder: (context) => Text(
                            ...
                            style: FlutterFlowTheme.of(context)
                                ...
                                .override(
                                  ...
                                  color: widget.companyDoc?.primaryTextColor,
                                  fontSize: 20.0,
                                  letterSpacing: 0.0,
                        ...
                        children: [
                          ...
                          Switch.adaptive(
                            ...
                            onChanged: (newValue) async {
                              ...
                              if (newValue) {
                                FFAppState().editMode = !FFAppState().editMode;
                                setState(() {});
                                FFAppState().isSearchingActivities = false;
                                FFAppState().isCreatingFacebook = false;
                                setState(() {});
                              } else {
                                FFAppState().editMode = !FFAppState().editMode;
                                setState(() {});
                  ...
                  if (widget.companyDoc?.licences.contains('journal') == true)
                    Opacity(
                      opacity: 0.9,
                      child: InkWell(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: Text(
                                      valueOrDefault<String>(
                                        widget.companyDoc?.nameForAiChat,
                                        'Chat',
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                  ...
                  if (widget.companyDoc?.licences.contains('journal') == true)
                    Opacity(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed('chatToMeChris');
                  ...
                  if (widget.companyDoc?.licences.contains('marketing') ==
                      true)
                    Opacity(
                      opacity: 0.9,
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed('JTPCalendarView');
                        },
                        child: AnimatedContainer(
                          duration: const Duration(milliseconds: 150),
                          curve: Curves.easeInOut,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed('AIiNSTRUCTIONS');
                          },
                          child: AnimatedContainer(
                            duration: const Duration(milliseconds: 150),
                            curve: Curves.easeInOut,
