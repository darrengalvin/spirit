...
import 'list_od_days_model.dart';
export 'list_od_days_model.dart';

class ListOdDaysWidget extends StatefulWidget {
  const ListOdDaysWidget({
    super.key,
  ...
  @override
  State<ListOdDaysWidget> createState() => _ListOdDaysWidgetState();
}

class _ListOdDaysWidgetState extends State<ListOdDaysWidget> {
  late ListOdDaysModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListOdDaysModel());
                ...
                builder: (context, snapshot) {
                  ...
                  return Container(
                    ...
                    child: Builder(
                      builder: (context) {
                        final awarenessDays =
                            containerAwarenessDaysRecordList.toList();
                        return Column(
